...
<header>
    ...
    <?php
        $tmp = mysqli_query($con,"select timi from kampilizitisis");
        $res = mysqli_fetch_array($tmp);
        if($res==""){
            echo "<p align='center'> <font color=blue size='6pt'>Δεν υπάρχουν δεδομένα για διαγραφή.</font> </p>";
            ...
            echo "<p align='center'> <font color=blue size='6pt'>Διαγραφή επιτυχής.</font> </p>";
        }
